...
const Projects = () => {
  ...
  return (
    <>
      ...
      >
        <div>
          <h1 className="text-3xl font-semibold mb-2 text-slate-950">Projects</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 my-12">
            {cardItem.map(({ id, logo, name, about, prev, source }) => (
              <div
                className="md:w-[300px] md:h-[300px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-105 duration-300 my-5 text-slate-900"
                key={id}
              >
                <img
                  src={logo}
                ...
                <div>
                  ...
                  <p className="px-2 text-[15.3px] text-gray-700">{about}</p>
                </div>
                <div className="flex justify-around px-6 py-4">
                  <button className="bg-slate-900 hover:bg-white duration-300 hover:text-slate-900 hover:border-2 rounded-md text-white font-bold px-4 py-2">
                    <a href={prev} target={"_blank"} >
                      Preview
                    </a>
                  </button>
                  <button className="bg-white hover:bg-slate-900 duration-300 hover:text-white text-slate-900 border-2 rounded-md font-bold px-4 py-2">
